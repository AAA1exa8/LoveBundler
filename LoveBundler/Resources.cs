...
public partial class Resources
{
    ...
    private static async Task<string> DownloadAsset(ReleaseAsset asset)
    {
    ...
    private static void UnpackResources(string assetsZip, string console = "")
    {
        ...
        foreach (var entry in zip.Entries)
        {
            ...
            if (!Directory.Exists(Path.GetDirectoryName(path)) && !string.IsNullOrEmpty(directory))
            {
